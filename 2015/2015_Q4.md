...
1. ***ZeroMQ: Messaging for Many Applications*** 5.0/5.0
  ...
  ***"the real physics of software is the physics of people"***, he focuses
  ...
  2017-02更新： 最近阅读了zeromq作者pieter hintjens的博客，其不久之前因癌症病逝
  。ph也是少年时期就开始编程，最早接触的可编程器件只有5KB内存，当后来出来64KB内
  存的计算机时，已被视为是计算怪兽。在读大学时已经能靠写游戏赚钱。后来出来最独
  立咨询师。参与设计了AMQP，后来开源了ZeroMQ。除了技术本身外，还喜欢研究哲学和社
  会学。
